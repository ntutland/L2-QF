...
def write_ignitions(shape_path, ig_path, firing_dir, burn_path, epsg = 4326,
                    rate = 1.5, fast = False, 
                    line_type = "line", dash_length = None, gap_length = None,
                    pattern = "strip", crew_size = 8, depth = 60, offset = 20):
    ...
    ig_pattern.to_quicfire(burn_domain,filename=os.path.join(ig_path,"ignite.dat"),dst_epsg=epsg,resolution=2)
...
if __name__=="__main__":
    ...
    write_ignitions(shape_path,ig_path,firing_dir,line_type = "dash",dash_freq = 10,pattern="head")
